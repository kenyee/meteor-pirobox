...
(function($) {
	...
	if(opt.zoom_animation == true){
		$('head').append('<script type="text/javascript" src="js/easing.js"></script>');
	}
				...
				wrapper.animate({
					...
					'left':  ((x/2)-((params[1])/2+opt.padding))
							...
							if($('.piro_caption p').height()> 28){
								$('.piro_caption p').css({'background':'url(caption_up_down.png) top right no-repeat','padding-right':'18px'});
							...
							$(img).fadeIn(700,function(){
								...
								$('.piro_caption').show(0,function(){
										...
										if($('.piro_caption p').height() > 28 || $('.piro_caption p').width() > imgW-(43*piro_nav_length) ){
											$('.piro_caption p').css({
												'background':'url(caption_up_down.png) top right no-repeat',
												'padding-right':'18px'
											});
